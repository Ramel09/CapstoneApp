...
import com.example.finalappdefense.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter=
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, int position, @NonNull AdminOrders model) {
                        ...
                        holder.userLetter.setText("Letter: "+model.getLetter());
    ...
    {
        public TextView userName, userPhoneNumber, userTotalPrice,userDateTime,userShippingAddress,userLetter;
        ...
        public AdminOrdersViewHolder(@NonNull View itemView) {
            ...
            userLetter = itemView.findViewById(R.id.order_letter);
